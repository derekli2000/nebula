/*
   The following code was taken from https://github.com/EvanBacon/expo-dark-mode-switch
   and repackaged into this single file for more convenient usage and extendability
   The accompanying MIT license is included in this folder
*/
...
const TouchableOpacity =
  NativeTouchableOpacity as React.ComponentType<WebTouchableOpacityProps>;
...
const MoonIcon = ({isClicked, ...props}: any) => {
...
const DayNightSwitch = ({isClicked}: any) => {
...
const Star = ({size = 3, x, y, index, isClicked, ...props}: any) => {
  const value = createAnimatedValue(isClicked);
...
const Stars = ({isClicked, ...props}: any) => {
  const value = createAnimatedValue(isClicked);
...
const Circle = ({isClicked, ...props}: any) => {
  const ref = React.useRef(null);
